...
lista_numcien = list(range(0, 101, 4))
print (lista_numcien)
print (type(lista_numcien))
"""
...
lista_cincoelem = ["Lionel", 10, "Diego", "GOAT", "D10s"]
print (lista_cincoelem [3])
print (lista_cincoelem [-2])
"""
...
### El programa busca el valor más alto de la lista dada y lo elimina.
#### Luego se imprime lista números con los valores que quedaron.
